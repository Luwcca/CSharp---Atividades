...
using System.Linq;
using System.Text;
using System.Text.RegularExpressions; //Biblioteca Regex
...
namespace ByteBank.SistemaAgencia
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ContaCorrente conta = new ContaCorrente(456,12345);
            ...
            string padrao =
            "[0-9]{4,5}-?[0-9]{4}"; // procura de 4 a 5 numeros entre 0 e 9, o {0,1} ou / pode ou não incluir o hífen
