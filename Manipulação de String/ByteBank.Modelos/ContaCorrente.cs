...
namespace ByteBank.Modelos
{
    ...
    // o /// é usado para documentar os metodos e
    // para salvar a documentação, é necessário utilizar mudar as propriedades de compilação do projeto e ativar a documentação xml
    // Após recompilar, copiar o arquivo e colar na mesma pasta do arquivo  dll
    /// <summary>
    ...
    public class ContaCorrente
    {
        ...
        /// </summary>
        //excepition cref - referencia uma exeção
        //paramref referencia um parametro
        //see cref referencia uma classe
